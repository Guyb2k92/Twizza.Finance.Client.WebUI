...
export class AuthenticationService {
    private email = 'guyb@twizza.co.zam'; // Use '=' for assignment
    ...
    constructor(private http: HttpClient) {
        this.http.configure(config => {
            ...
            config.withBaseUrl('https://dev.clarkservices.co.za/Twizza.Security.WebApi');
        });
    }
    ...
    public HasPermission(secobj: string): boolean {
        ...
        return this.currentUser.value.Claims.find(claim => claim.Type == secobj) !== undefined;
    }
